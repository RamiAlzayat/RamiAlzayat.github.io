!(function ($) {
  ...
  if (
      ...
      function (e) {
        if (
          ...
          if (target.length) {
            ...
            return (
              $("#header").length && (scrollto -= $("#header").outerHeight()),
              "#header" == $(this).attr("href") && (scrollto = 0),
              $("html, body").animate(
                { scrollTop: scrollto },
                1500,
                "easeInOutExpo"
              ...
              $(".js-append-target").hasClass("mobile-nav-active") &&
    ...
    var $mobile_nav = $(".nav-menu")
      .clone()
      .prop({ class: "mobile-nav d-lg-none" });
    $(".js-append-target").append($mobile_nav),
      $(".js-append-target").prepend(
        '<button type="button" class="mobile-nav-toggle d-lg-none" aria-label="mobile nav toggle"><i class="icofont-navigation-menu"></i></button>'
      ),
  ...
  $(window).on("scroll", function () {
    ...
    nav_sections.each(function () {
      ...
      cur_pos >= top &&
        cur_pos <= bottom &&
        (cur_pos <= bottom && main_nav.find("li").removeClass("active"),
        main_nav
          .find('a[href="#' + $(this).attr("id") + '"]')
          .parent("li")
          .addClass("active")),
        cur_pos < 300 && $(".nav-menu ul:first li:first").addClass("active");
    });
  }),
    ...
    $(".back-to-top").click(function () {
      return (
        $("html, body").animate({ scrollTop: 0 }, 1500, "easeInOutExpo"), !1
      );
    }),
    $(window).on("load", function () {
